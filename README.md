...
![Lines](https://img.shields.io/badge/Lines-483-ffb800?style=for-the-badge)
...
```bash
# Clone
git clone https://github.com/7IKED/dkz-unit-converter.git

# Oeffnen
cd dkz-unit-converter
